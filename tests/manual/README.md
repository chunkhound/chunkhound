...
- Extended thinking has two modes:
  - Adaptive (Claude Fable 5, Mythos 5, Opus 4.8, Opus 4.7, Opus 4.6, Sonnet 4.6, Mythos Preview). No budget_tokens needed. Auto-enables interleaved thinking.
  - Manual (Opus 4.5 and older Claude 4 models). Requires thinking.budget_tokens of at least 1024.
- Fable 5, Mythos 5, Opus 4.7, and Opus 4.8 accept only adaptive thinking; manual is rejected with a 400 error. On Fable 5 and Mythos 5, adaptive thinking is always on: omitting the thinking parameter does not disable it.
- The effort parameter (low/medium/high/xhigh/max) is supported on Fable 5, Mythos 5, Opus 4.5/4.6/4.7/4.8, Sonnet 4.6, and Mythos Preview. xhigh is Fable 5/Mythos 5/Opus 4.7/4.8; max is 4.6 and later.
