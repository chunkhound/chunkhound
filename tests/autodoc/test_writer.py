...
def test_write_autodoc_outputs_without_topics(tmp_path: Path) -> None:
    result = write_autodoc_outputs(
        out_dir=tmp_path,
        scope_label="scope",
        meta=_meta(),
...
def test_write_autodoc_outputs_with_topics_and_unreferenced(tmp_path: Path) -> None:
    meta = _meta()
    result = write_autodoc_outputs(
        out_dir=tmp_path,
        scope_label="scope",
