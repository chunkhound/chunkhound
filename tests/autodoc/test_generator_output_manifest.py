...
_MINIMAL_EXPECTED_MANIFEST: dict[str, str] = {
    ...
    "src/data/nav.json": (
        "d0792e0389ee490c84830888c8c97c9e307bc06b906d743ad66bc9614bcd6bf0"
    ),
    "src/data/search.json": (
        "d9ea92a1e297c48fb6979881a9b66a8bac4cd9b925186c441781942c1b7f3f16"
    ),
    "src/data/site.json": (
        "49e61d0315bb0753b7160af9be4845c28561857f48791e2d78df5d72a5e7305d"
    ),
    "src/layouts/DocLayout.astro": (
        "fde0db562238b8f202b935011b8563fc03e785a9d19a7d451f88dc4367a225ac"
    ),
    "src/pages/index.md": (
        "3b725a642845ebf01515b7e6e7da8dcb61712e3a89169efc92f19e51c13b8d2e"
    ),
    "src/pages/topics/01-topic-one.md": (
        "60e90338d4c20535a0af955879ca34068bfb0016b8ef5f401e3596abe3b1b197"
    ),
...
@pytest.mark.asyncio
async def test_generate_docsite_minimal_mode_emits_byte_stable_tree(
    tmp_path: Path,
    ...
    assert build_tree_manifest(Path("out")) == _MINIMAL_EXPECTED_MANIFEST
