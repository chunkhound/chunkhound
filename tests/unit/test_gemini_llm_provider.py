...
class TestGeminiLLMProvider:
    ...
    def test_provider_models_supported(self):
        ...
        # Gemini 2.5 Flash
        provider_2_5_flash = GeminiLLMProvider(api_key="test-key", model="gemini-2.5-flash")
    ...
    def test_build_generation_config_thinking_budget_gemini_2_5(self):
        ...
        assert hasattr(config, "thinking_config") or "thinking_config" in config.__dict__
