...
def fake_llm_provider():
    ...
    return FakeLLMProvider(
        responses={
            ...
            "follow": (
                '{"questions": ["How is caching implemented?",'
                ' "What are the data structures used?",'
                ' "How does error handling work?"]}'
            ),
            "generate": (
                '{"questions": ["Implementation details?", "Architecture patterns?"]}'
            ),
            # Synthesis (JSON)
            "synthesis": (
                '{"reasoning": "Combining related questions'
                ' about authentication and storage",'
                ' "questions": ["How does the authentication'
                ' and session storage system work together?"]}'
            ),
            "synthesize": (
                '{"reasoning": "Merging questions",'
                ' "questions": ["Combined question 1",'
                ' "Combined question 2"]}'
            ),
