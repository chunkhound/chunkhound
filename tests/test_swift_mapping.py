...
"""
        ...
        "deinit" in symbols or any("deinit" in c.code for c in chunks)
...
"""
        ...
        any("subscript" in s.lower() for s in symbols) or any(
...
"""
        ...
        [c for c in chunks if "import" in c.code.lower()]
        # Imports may or may not be captured as
        # separate chunks depending on configuration
