...
export const llmProviders: ConfiguratorProviderOption[] = [
    ...
    },
    {
        ...
        setupHint:
            "Requires the local 'agy' (or 'antigravity') CLI, version 1.1.9 or newer, installed and authenticated on your PATH — no Python extra needed. Older versions reject the --disable-slash-commands and --output-format flags ChunkHound passes; run 'agy update' if the CLI exits with code 2.",
    },
    {
        id: "deepseek",
        name: "DeepSeek",
