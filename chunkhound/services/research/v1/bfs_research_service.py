"""BFS Research Service for ChunkHound - v1 BFS-based semantic exploration."""
...
class BFSResearchService:
    """Service for performing deep research using BFS exploration (v1 implementation)."""
