...
@dataclass
class AutodocRunContext:
    comprehensiveness: str
    max_points: int


@dataclass
class AutodocMetadataBundle:
...
class AutodocOrchestrator:
    """Prepare scope, metadata, and run context for autodoc CLI flows."""
    ...
    def resolve_scope(self) -> AutodocScope:
    ...
    def run_context(self) -> AutodocRunContext:
    ...
    def metadata_bundle(
        ...
        *,
        ...
        return AutodocMetadataBundle(meta=meta, assembly_provider=assembly_provider)
