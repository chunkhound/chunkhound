...
from chunkhound.autodoc.markdown_utils import _strip_first_heading, _strip_markdown_for_search
...
async def _synthesize_site_ia(
    *,
    ...
    glossary_terms = _validate_glossary_terms(response.get("glossary"), slugs, log_warning)
...
def _validate_glossary_terms(
    ...
    for entry in glossary:
        ...
        output.append(
            {"term": term.strip(), "definition": definition.strip(), "pages": cleaned_pages}
        )
