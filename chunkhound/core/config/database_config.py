...
class DatabaseConfig(BaseModel):
    ...
    lancedb_optimize_fragment_threshold: int = Field(
        ...
        description=(
            ...
            "(0 = always). Product default 100: OpenJDK-scale full-flow "
            "(~2M chunks) preferred thr=100 over 50 (thr=50 over-optimizes). "
            "Synthetic small full-flow slightly preferred 50; thr≥200 raises "
            "wall. See operations/indexing_timing_ledger.md OpenJDK section."
        ),
    )
